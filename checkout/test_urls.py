...
class TestBasketUrls(SimpleTestCase):
    ...
    def test_checkout_url(self):
        """Testing basket/ checkout url (function = url name)"""
        url = reverse('checkout')
        self.assertEquals(resolve(url).func, checkout)

    def test_checkout_confirm_url(self):
        """Testing basket/ checkout_confirm url (function = url name)"""
    ...
    def test_save_checkout_data_url(self):
        """Testing basket/ save_checkout_data url (function = url name)"""
        url = reverse('save_checkout_data')
        self.assertEquals(resolve(url).func, save_checkout_data)

    def test_webhook_url(self):
        """Testing basket/ webhook url (function = url name)"""
        url = reverse('webhook')
